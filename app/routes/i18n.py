...
DEFAULT_TRANSLATIONS = {
    'ru': {
        'common': {
            ...
            'create_first_post': 'Создайте первый пост выше!',
            'captcha_protection': 'защита от ботов',
        },
        'auth': {
            'login_title': 'Вход',
        ...
        'posts': {
            ...
            'login_to_create': 'Войдите, чтобы создать пост',
    ...
    'uk': {
        'common': {
            ...
            'popular': 'Популярні',
            'following': 'Підписки',
            'no_posts_yet': 'Поки що немає постів',
            'create_first_post': 'Створіть перший пост вище!',
            'captcha_protection': 'захист від ботів',
        },
        'auth': {
            'login_title': 'Вхід',
        ...
        'posts': {
            ...
            'login_to_create': 'Увійдіть, щоб створити пост',
    ...
    'en': {
        'common': {
            ...
            'create_first_post': 'Create the first post above!',
            'captcha_protection': 'bot protection',
        },
        'pages': {
            'rules': 'Rules',
            'about': 'About',
        ...
        'posts': {
            ...
            'login_to_create': 'Login to create post',
    ...
    'kz': {
        'common': {
            ...
            'no_posts_yet': 'Әлі посттар жоқ',
            'create_first_post': 'Жоғарыда алғашқы постты жасаңыз!',
        },
        'pages': {
            'rules': 'Ережелер',
            'about': 'Біз туралы',
        ...
        'posts': {
            ...
            'login_to_create': 'Пост жасау үшін кіріңіз',
            'image_optional': 'Сурет (міндетті емес)',
            'publish': 'Жариялау',
        },
        'profile': {
            'profile': 'Профиль',
